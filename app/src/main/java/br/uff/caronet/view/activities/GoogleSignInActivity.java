...
public class GoogleSignInActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Dao.get().setGcClient(mGoogleSignInClient);
    ...
    private void firebaseAuthWithGoogle(GoogleSignInAccount acct) {
        ...
        Log.d(TAG, "firebaseAuthWithGoogle name: " + acct.getDisplayName());
    ...
    private void checkRegistered(FirebaseUser user) {
        ...
        Dao.get().getClUsers().document(user.getUid()).get().addOnCompleteListener(task -> {
            if (task.isSuccessful()){
                ...
                if (document.exists()){
                    ...
                    Dao.get().setUser(userObj);

                    // Go to Rides Activity
